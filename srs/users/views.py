...
from main.models import Listing, Liked_View_Listing
    ...
    if request.method == "POST":
        ...
        if login_form.is_valid():
            ...
            if user is not None:
                ...
                messages.error(request, f'An error occured trying to login as {username}')
        else:
...
class RegisterView(View): # Class based view for register view
...
class ProfileView(View):
    ...
    def get(self, request):
        ...
        user_liked_listings = Liked_View_Listing.objects.filter(profile=request.user.profile).all()
