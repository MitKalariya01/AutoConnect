...
def main_view(request):
    ...
    return render(request, "views/main.html", {"project_nm":"AutoMax! :)"})

@login_required
def home_view(request):
    listings = Listing.objects.all()
    listing_filter = ListingFilter(request.GET, queryset=listings)
    user_liked_listings = Liked_View_Listing.objects.filter(
...
def liked_listing_view(request, id):
    ...
    liked_listing, created = Liked_View_Listing.objects.get_or_create(
